    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnTransformadaFourier_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (transformada != null)
            {
                ...
                else if (frecuenciaFundamental > 795 && frecuenciaFundamental < 805)
                {
                    lblFrecuenciaFundamental_Color.Text = "Verde";
                }
                else if (frecuenciaFundamental > 1195 && frecuenciaFundamental < 1205)
                {
                    lblFrecuenciaFundamental_Color.Text = "Morado";
                }
                else if (frecuenciaFundamental > 1595 && frecuenciaFundamental < 1605)
                {
                    lblFrecuenciaFundamental_Color.Text = "Azul";
                }
                else if (frecuenciaFundamental > 1995 && frecuenciaFundamental < 2005)
                {
